...
public class BatchForfeitRequestWrite implements
        OnCompleteListener<Void> {

    private static final String TAG = "BatchForfeitRequestWrite";
    ...
    public void writeForfeitRequest(DatabaseReference batchForfeitRequestRef, String clientId, String batchGuid, BatchDetail.BatchType batchType,
                                  Response response){

        Timber.tag(TAG).d("writeForfeitRequest START...");
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.writeForfeitRequestComplete();
    }

    public interface Response {
        void writeForfeitRequestComplete();
    }
}
