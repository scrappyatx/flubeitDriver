...
package it.flube.driver.deviceLayer.cloudServices.cloudActiveBatch.acknowledgeFinishedBatch;
...
public class FirebaseActiveBatchAcknowledgeFinishedBatch implements
    ...
    private CloudActiveBatchInterface.AcknowledgeFinishedBatchResponse response;

    public void acknowledgeFinishedBatch(DatabaseReference activeBatchRef, CloudActiveBatchInterface.AcknowledgeFinishedBatchResponse response){
    ...
    public void setDataComplete(){
        response.cloudActiveBatchFinishedBatchAckComplete();
    }
}
