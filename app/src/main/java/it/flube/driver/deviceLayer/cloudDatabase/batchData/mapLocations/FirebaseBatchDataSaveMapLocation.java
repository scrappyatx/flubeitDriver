...
package it.flube.driver.deviceLayer.cloudDatabase.batchData.mapLocations;
...
public class FirebaseBatchDataSaveMapLocation
    ...
    private CloudDatabaseInterface.SaveMapLocationResponse response;
    ...
    public void saveMapLocation(DatabaseReference batchDataRef,
                               ...
                               LatLonLocation location,
                                CloudDatabaseInterface.SaveMapLocationResponse response){
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.cloudDatabaseSaveMapLocationComplete();
    }
