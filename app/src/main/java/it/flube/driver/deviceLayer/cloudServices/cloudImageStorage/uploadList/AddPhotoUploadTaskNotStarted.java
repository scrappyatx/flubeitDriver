...
import it.flube.driver.deviceLayer.cloudServices.cloudImageStorage.uploadTasks.SetNodeFailed;
import it.flube.driver.deviceLayer.cloudServices.cloudImageStorage.uploadTasks.SetNodeFinished;
import it.flube.driver.deviceLayer.cloudServices.cloudImageStorage.uploadTasks.SetNodeInProgress;
import it.flube.driver.deviceLayer.cloudServices.cloudImageStorage.uploadTasks.SetNodeNotStarted;
...
public class AddPhotoUploadTaskNotStarted implements
    ...
    AddPhotoUploadTaskNotStartedResponse response;
    ...
    public void setNodeFailedComplete(Integer attemptCount){
        // we're done, return
        response.addPhotoUploadTaskComplete();
    }

    public interface AddPhotoUploadTaskNotStartedResponse {
        void addPhotoUploadTaskComplete();
    }
}
