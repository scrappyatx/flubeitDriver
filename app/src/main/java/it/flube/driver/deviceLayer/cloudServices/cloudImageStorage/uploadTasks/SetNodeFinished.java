...
import static it.flube.driver.deviceLayer.cloudServices.cloudImageStorage.uploadTasks.Constants.UPLOAD_TASKS_FINISHED_NODE;
...
public class SetNodeFinished implements
        OnCompleteListener<Void> {

    public static final String TAG = "SetNodeFinished";

    private Response response;

    public SetNodeFinished(){
    ...
    public void addNodeRequest(DatabaseReference batchDataNodeRef,
        ...
        batchDataNodeRef.child(batchGuid).child(UPLOAD_TASKS_FINISHED_NODE).child(deviceGuid).child(photoRequestGuid).setValue(data).addOnCompleteListener(this);
    ...
    public void removeNodeRequest(DatabaseReference batchDataNodeRef, String batchGuid, String deviceGuid, String photoRequestGuid,
        ...
        batchDataNodeRef.child(batchGuid).child(UPLOAD_TASKS_FINISHED_NODE).child(deviceGuid).child(photoRequestGuid).setValue(null).addOnCompleteListener(this);
    }
