...
public class MovePhotoUploadTaskToInProgress implements
    ...
    public MovePhotoUploadTaskToInProgress(){
        Timber.tag(TAG).d("created...");
    }

    public void movePhotoUploadTaskToInProgress(DatabaseReference batchDataNodeRef,
        ...
        //Step 1 -> set node in progress for this photo request
        new SetNodeInProgress().addNodeRequest(batchDataNodeRef, batchGuid, serviceOrderGuid, orderStepGuid, photoRequestGuid, deviceGuid,
                deviceAbsoluteFileName, cloudStorageFileName, sessionUriString, progress, this);
    }
    ...
    public void setNodeFailedComplete(Integer attemptCount){
        // we're done, return
        response.cloudDatabaseMovePhotoUploadTaskToInProgressComplete();
    }
