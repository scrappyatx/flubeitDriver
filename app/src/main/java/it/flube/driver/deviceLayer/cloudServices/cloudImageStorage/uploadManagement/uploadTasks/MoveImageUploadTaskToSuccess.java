 ...
 * Project : Driver
 */
public class MoveImageUploadTaskToSuccess implements
        OnCompleteListener<Void> {

    private static final String TAG = "MoveImageUploadTaskToSuccess";

    private Response response;

    public MoveImageUploadTaskToSuccess() {
        Timber.tag(TAG).d("created...");
    }

    public void moveImageUploadTaskToSuccess(DatabaseReference uploadTaskNodeRef, String ownerGuid, Response response) {
        Timber.tag(TAG).d("moveImageUploadTaskToSuccess..");
        ...
        childUpdates.put(String.format(RTD_SUCCESS_NODE, ownerGuid), true);              // success
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.moveImageUploadTaskToSuccessComplete();
    }

    public interface Response {
        void moveImageUploadTaskToSuccessComplete();
    }
}
