 ...
 * Project : Driver
 */
public class FirebasePublicOfferRouteStopListGet implements ValueEventListener {
    private static final String TAG = "FirebasePublicOfferRouteStopListGet";

    private static final String BATCH_DATA_ROUTE_STOPS_NODE = "routeStops";

    private CloudPublicOfferInterface.GetRouteStopListResponse response;

    public void getRouteStopListRequest(DatabaseReference batchDataRef, String batchGuid, CloudPublicOfferInterface.GetRouteStopListResponse response){
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.exists()) {
            ...
            try {
                ...
                response.cloudGetPublicOfferRouteStopListSuccess(routeStopList);

            } catch (Exception e) {
                Timber.tag(TAG).w("   ...ERROR");
                Timber.tag(TAG).e(e);
                response.cloudGetPublicOfferRouteStopListFailure();
            }
