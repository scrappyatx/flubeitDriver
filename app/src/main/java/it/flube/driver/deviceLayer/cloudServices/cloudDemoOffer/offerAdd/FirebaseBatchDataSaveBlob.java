...
public class FirebaseBatchDataSaveBlob implements OnCompleteListener<Void> {
    ...
    public void saveDemoBatchDataRequest(DatabaseReference batchDataRef, BatchHolder batchHolder, Response response) {
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.saveDemoBatchDataComplete();
    }

    public interface Response {
        void saveDemoBatchDataComplete();
    }
