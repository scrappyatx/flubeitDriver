...
public class FirebaseServiceOrderListGet implements ValueEventListener {
    ...
    private GetServiceOrderListResponse response;

    public void getServiceOrderListRequest(DatabaseReference batchDataRef, String batchGuid, GetServiceOrderListResponse response){
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.exists()) {
            ...
            try {
                ...
                response.getServiceOrderListSuccess(orderList);

            } catch (Exception e) {
                Timber.tag(TAG).w("   ...ERROR");
                Timber.tag(TAG).e(e);
                response.getServiceOrderListFailure();
            }
    ...
    public interface GetServiceOrderListResponse {
        void getServiceOrderListSuccess(ArrayList<ServiceOrder> orderList);

        void getServiceOrderListFailure();
    }
