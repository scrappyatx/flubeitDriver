...
public class MoveImageUploadTaskToInProgress implements
        OnCompleteListener<Void> {

    private static final String TAG = "MoveImageUploadTaskToInProgress";

    private Response response;

    public MoveImageUploadTaskToInProgress(){
        Timber.tag(TAG).d("created...");
    }

    public void moveImageUploadTaskToInProgress(DatabaseReference uploadTaskNodeRef, String ownerGuid, Response response) {
        Timber.tag(TAG).d("moveImageUploadTaskToInProgress...");
        ...
        childUpdates.put(String.format(RTD_IN_PROGRESS_NODE, ownerGuid), true);          // inProgress
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.moveImageUploadTaskToInProgressComplete();
    }

    public interface Response {
        void moveImageUploadTaskToInProgressComplete();
    }
