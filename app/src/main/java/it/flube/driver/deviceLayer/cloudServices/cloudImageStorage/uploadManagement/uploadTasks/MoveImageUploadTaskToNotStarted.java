...
public class MoveImageUploadTaskToNotStarted implements
        OnCompleteListener<Void> {

    private static final String TAG = "MoveImageUploadTaskToNotStarted";

    private Response response;

    public MoveImageUploadTaskToNotStarted(){
        Timber.tag(TAG).d("created...");
    }

    public void moveImageUploadTaskToNotStarted(DatabaseReference uploadTaskNodeRef, String ownerGuid, Response response) {
        ...
        childUpdates.put(String.format(RTD_NOT_STARTED_NODE, ownerGuid), true);          // notStarted
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.moveImageUploadTaskToNotStartedComplete();
    }

    public interface Response {
        void moveImageUploadTaskToNotStartedComplete();
    }
