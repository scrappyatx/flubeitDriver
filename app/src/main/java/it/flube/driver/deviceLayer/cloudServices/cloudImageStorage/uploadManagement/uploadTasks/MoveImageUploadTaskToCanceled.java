 ...
 * Project : Driver
 */
public class MoveImageUploadTaskToCanceled implements
        OnCompleteListener<Void> {

    private static final String TAG = "MoveImageUploadTaskToCanceled";

    private Response response;

    public MoveImageUploadTaskToCanceled(){
        Timber.tag(TAG).d("created...");
    }

    public void moveImageUploadTaskToCanceled(DatabaseReference uploadTaskNodeRef, String ownerGuid, Response response) {
        Timber.tag(TAG).d("moveImageUploadTaskToCanceled...");
        ...
        childUpdates.put(String.format(RTD_CANCELED_NODE, ownerGuid), true);             // canceled
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.moveImageUploadTaskToCanceledComplete();
    }

    public interface Response {
        void moveImageUploadTaskToCanceledComplete();
    }
