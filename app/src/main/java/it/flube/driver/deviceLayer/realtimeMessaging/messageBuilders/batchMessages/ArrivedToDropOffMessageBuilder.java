...
public class ArrivedToDropOffMessageBuilder {
    private final String TAG = "MessageBuilder";

    private JSONObject mMessageBody;
    private String mMessageName;

    public ArrivedToDropOffMessageBuilder(String batchOID){
        mMessageName = "arrivedToDropOff";
        ...
        try {
            ...
            Rollbar.reportException(e, "critical", "JSON exception while trying to build message --> arrivedToDropOff");
        }
    }
