...
public class MoveImageUploadTaskToFailed implements
        OnCompleteListener<Void> {

    private static final String TAG = "MoveImageUploadTaskToFailed";

    private Response response;

    public MoveImageUploadTaskToFailed(){
        Timber.tag(TAG).d("created...");
    }

    public void moveImageUploadTaskToFailed(DatabaseReference uploadTaskNodeRef, String ownerGuid, Response response) {
        Timber.tag(TAG).d("moveImageUploadTaskToFailed...");
        ...
        childUpdates.put(String.format(RTD_FAILED_NODE, ownerGuid), true);               // failed
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.moveImageUploadTaskToFailedComplete();
    }

    public interface Response {
        void moveImageUploadTaskToFailedComplete();
    }
