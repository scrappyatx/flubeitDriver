 ...
 * Project : Driver
 */
public class FirebaseDemoRouteStopListGet implements ValueEventListener {
    private static final String TAG = "FirebaseDemoRouteStopListGet";

    private static final String BATCH_DATA_ROUTE_STOPS_NODE = "routeStops";

    private CloudDemoOfferInterface.GetRouteStopListResponse response;

    public void getRouteStopListRequest(DatabaseReference batchDataRef, String batchGuid, CloudDemoOfferInterface.GetRouteStopListResponse response){
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.exists()) {
            ...
            try {
                ...
                response.cloudGetDemoRouteStopListSuccess(routeStopList);

            } catch (Exception e) {
                Timber.tag(TAG).w("   ...ERROR");
                Timber.tag(TAG).e(e);
                response.cloudGetDemoRouteStopListFailure();
            }
