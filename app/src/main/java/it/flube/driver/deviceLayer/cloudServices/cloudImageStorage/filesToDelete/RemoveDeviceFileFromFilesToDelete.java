 ...
 * Project : Driver
 */
public class RemoveDeviceFileFromFilesToDelete implements
        OnCompleteListener<Void> {
    public static final String TAG = "RemoveDeviceFileFromFilesToDelete";

    private Response response;

    public void removeDeviceFileFromFilesToDelete(FirebaseDatabase driverDb, FileToUploadInfo fileToUploadInfo, Response response) {
        Timber.tag(TAG).d("removeDeviceFileFromFilesToDelete");
        ...
        driverDb.getReference(filesToDeleteNode).child(fileToUploadInfo.getDeletionKey()).setValue(null).addOnCompleteListener(this);
    }
    ...
    public void onComplete(@NonNull Task<Void> task) {
        ...
        response.removeDeviceFileFromFilesToDeleteComplete();
    }

    public interface Response {
        void removeDeviceFileFromFilesToDeleteComplete();
    }
}
