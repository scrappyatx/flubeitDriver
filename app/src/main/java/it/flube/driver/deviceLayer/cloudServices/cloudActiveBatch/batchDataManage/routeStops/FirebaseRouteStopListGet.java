...
package it.flube.driver.deviceLayer.cloudServices.cloudActiveBatch.batchDataManage.routeStops;
...
public class FirebaseRouteStopListGet implements ValueEventListener {
    ...
    private GetRouteStopListResponse response;

    public void getRouteStopListRequest(DatabaseReference batchDataRef, String batchGuid, GetRouteStopListResponse response){
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.exists()) {
            ...
            try {
                ...
                response.getRouteStopListSuccess(routeStopList);

            } catch (Exception e) {
                Timber.tag(TAG).w("   ...ERROR");
                Timber.tag(TAG).e(e);
                response.getRouteStopListFailure();
            }
    ...
    public interface GetRouteStopListResponse {
        void getRouteStopListSuccess(ArrayList<RouteStop> routeStopList);

        void getRouteStopListFailure();
    }
