 ...
 * Project : Driver
 */
public class FirebasePublicOfferDetailGet implements ValueEventListener {
    private static final String TAG = "FirebasePublicOfferDetailGet";
    private static final String BATCH_DETAIL = "batchDetail";

    private CloudPublicOfferInterface.GetBatchDetailResponse response;

    public FirebasePublicOfferDetailGet(){}

    public void getBatchDetailRequest(DatabaseReference batchDataRef, String batchGuid, CloudPublicOfferInterface.GetBatchDetailResponse response){
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.exists()) {
            ...
            try {
                ...
                response.cloudGetPublicOfferBatchDetailSuccess(batchDetail);
            } catch (Exception e) {
                Timber.tag(TAG).w("      ...error while trying to get batch detail data");
                Timber.tag(TAG).e(e);
                response.cloudGetPublicOfferBatchDetailFailure();
            }
        } else {
