 ...
 * Project : Driver
 */
public class FirebaseScheduledBatchRouteStopListGet implements
        ValueEventListener {

    private static final String TAG = "FirebaseScheduledBatchRouteStopListGet";
    private static final String BATCH_DATA_ROUTE_STOPS_NODE = "routeStops";

    private CloudScheduledBatchInterface.GetRouteStopListResponse response;

    public void getRouteStopListRequest(DatabaseReference batchDataRef, String batchGuid, CloudScheduledBatchInterface.GetRouteStopListResponse response){
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot.exists()) {
            ...
            try {
                ...
                response.cloudGetScheduledBatchRouteStopListSuccess(routeStopList);

            } catch (Exception e) {
                Timber.tag(TAG).w("   ...ERROR");
                Timber.tag(TAG).e(e);
                response.cloudGetScheduledBatchRouteStopListFailure();
            }
