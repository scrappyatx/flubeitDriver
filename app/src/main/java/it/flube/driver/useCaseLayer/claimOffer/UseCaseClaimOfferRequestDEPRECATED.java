...
public class UseCaseClaimOfferRequestDEPRECATED implements
        Runnable,
        RealtimeMessagingInterface.OfferChannel.ClaimOfferResponse {

    private final MobileDeviceInterface device;
    private final UseCaseClaimOfferRequestDEPRECATED.Response response;
    private final String offerOID;
    private Boolean responseSeenForThisRequest;

    public UseCaseClaimOfferRequestDEPRECATED(MobileDeviceInterface device, Offer offer, UseCaseClaimOfferRequestDEPRECATED.Response response ){
        this.device = device;
