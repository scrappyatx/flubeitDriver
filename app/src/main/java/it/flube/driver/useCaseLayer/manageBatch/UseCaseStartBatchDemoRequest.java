...
public class UseCaseStartBatchDemoRequest implements
    ...
    private final DemoBatchBuilderInterface demoBatchBuilder;
    ...
    public UseCaseStartBatchDemoRequest(MobileDeviceInterface device, DemoBatchBuilderInterface demoBatchBuilder, BatchCloudDB batchToStart, UseCaseStartBatchDemoRequest.Response response){
        this.device = device;
    ...
    public void run(){
        ...
        demoBatch = demoBatchBuilder.getSimpleBatch(device.getUser().getDriver(), batchToStart);
