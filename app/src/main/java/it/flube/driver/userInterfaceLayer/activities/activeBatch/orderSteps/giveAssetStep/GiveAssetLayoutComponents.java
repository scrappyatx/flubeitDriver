...
import it.flube.driver.userInterfaceLayer.activities.activeBatch.orderSteps.receiveAssetStep.layoutComponents.ContactPersonLayoutComponent;
 ...
 * Project : Driver
 */
public class GiveAssetLayoutComponents implements
    ...
    private static final String TAG = "GiveAssetLayoutComponents";
    ...
    public GiveAssetLayoutComponents(AppCompatActivity activity, String stepCompleteButtonCaption, Response response){
    ...
    public void setValues(AppCompatActivity activity, ServiceOrderGiveAssetStep orderStep){
    ...
    public ServiceOrderGiveAssetStep getOrderStep(){
        Timber.tag(TAG).d("ServiceOrderGiveAssetStep");
