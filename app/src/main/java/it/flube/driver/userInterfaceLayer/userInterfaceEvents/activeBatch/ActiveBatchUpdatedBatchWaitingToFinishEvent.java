 ...
 * Project : Driver
 */
public class ActiveBatchUpdatedBatchWaitingToFinishEvent {
    private ActiveBatchManageInterface.ActorType actorType;
    private String batchGuid;

    public ActiveBatchUpdatedBatchWaitingToFinishEvent(ActiveBatchManageInterface.ActorType actorType, String batchGuid){
