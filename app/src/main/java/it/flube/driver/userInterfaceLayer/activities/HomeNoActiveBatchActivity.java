...
import it.flube.driver.dataLayer.controllers.HomeNoActiveBatchController;
...
public class HomeNoActiveBatchActivity extends AppCompatActivity {
    ...
    private HomeNoActiveBatchController mController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "HomeNoActiveBatchActivity CREATED");
    }
    ...
    public void onStart() {
        ...
        mController = new HomeNoActiveBatchController();
