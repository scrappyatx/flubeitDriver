...
package it.flube.driver.userInterfaceLayer.userInterfaceEvents.offerListUpdates;
...
public class PublicOffersUpdatedEvent {
    private ArrayList<Batch> offerList;
    private int offerCount;

    public PublicOffersUpdatedEvent(ArrayList<Batch> offerList){
