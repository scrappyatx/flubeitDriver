 ...
 * Project : Driver
 */
public class ActiveBatchUpdatedBatchFinishedEvent {
    private ActiveBatchManageInterface.ActorType actorType;
    private String batchGuid;

    public ActiveBatchUpdatedBatchFinishedEvent(ActiveBatchManageInterface.ActorType actorType, String batchGuid){
