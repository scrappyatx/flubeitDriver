...
import it.flube.driver.dataLayer.controllers.ScheduledBatchesController;
...
public class ScheduledBatchesActivity extends AppCompatActivity {
    ...
    private ScheduledBatchesController mController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "ScheduledBatchesActivity CREATED");
    }
    ...
    public void onStart() {
        ...
        mController = new ScheduledBatchesController();
