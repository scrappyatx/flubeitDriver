...
public class DriverTakesVehicleFromService {
    private final String TAG = "MessageBuilder";

    private JSONObject mMessageBody;
    private String mMessageName;

    public DriverTakesVehicleFromService(String batchOID){
        mMessageName = "driverTakesCarFromService";
        ...
        try {
            ...
            Rollbar.reportException(e, "critical", "JSON exception while trying to build message --> driverTakesCar");
        }
    }
