...
public class ServerMessagingDELETE {
    private static final String TAG = "ServerMessagingDELETE";
    ...
    public ServerMessagingDELETE(String clientId) {
        //setup Ably
        try {
            initAbly(clientId);
            isConnected = true;
            ...
            public void onMessage(Message message) {
                ...
                switch (message.name) {
                    case "offerlist":
                        ...
                        EventBus.getDefault().post(new EbEventOfferListDELETE(mOfferList));
