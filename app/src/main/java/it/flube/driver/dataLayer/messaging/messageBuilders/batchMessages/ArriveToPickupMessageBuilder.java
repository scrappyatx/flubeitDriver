...
public class ArriveToPickupMessageBuilder {
    private final String TAG = "MessageBuilder";

    private JSONObject mMessageBody;
    private String mMessageName;

    public ArriveToPickupMessageBuilder(String batchOID){
        mMessageName = "arrivedToPickup";
        ...
        try {
            ...
            Rollbar.reportException(e, "critical", "JSON exception while trying to build message --> arrivedToPickup");
        }
    }
