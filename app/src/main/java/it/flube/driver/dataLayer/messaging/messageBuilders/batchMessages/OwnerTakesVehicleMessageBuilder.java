...
public class OwnerTakesVehicleMessageBuilder {
    private final String TAG = "MessageBuilder";

    private JSONObject mMessageBody;
    private String mMessageName;

    public OwnerTakesVehicleMessageBuilder(String batchOID){
        mMessageName = "ownerTakesVehicle";
        ...
        try {
            ...
            Rollbar.reportException(e, "critical", "JSON exception while trying to build message --> ownerTakesVehicle");
        }
    }
