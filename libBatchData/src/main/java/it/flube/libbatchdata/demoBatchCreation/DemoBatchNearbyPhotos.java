...
import it.flube.libbatchdata.builders.BatchHolderBuilder;
import it.flube.libbatchdata.builders.BuilderUtilities;
import it.flube.libbatchdata.builders.LatLonLocationBuilder;
import it.flube.libbatchdata.builders.NavigationStepBuilder;
...
import it.flube.libbatchdata.builders.PhotoStepBuilder;
import it.flube.libbatchdata.builders.PotentialEarningsBuilder;
import it.flube.libbatchdata.builders.ServiceOrderScaffoldBuilder;
...
public class DemoBatchNearbyPhotos implements DemoBatchInterface {
                ...
                .addServiceOrder(new ServiceOrderScaffoldBuilder.Builder()
                        ...
                        .addStep(new NavigationStepBuilder.Builder()
                                ...
                                .destination(new DestinationBuilder.Builder()
                                        .targetAddress(getAddressByClientId(clientId))
                                        .targetLatLon(getLatLonLocationByClientID(clientId))
    ...
    private AddressLocation getAddressByClientId(String clientId){
        String street;
        String city;
        String state;
        String zip;
    ...
    private LatLonLocation getLatLonLocationByClientID(String clientId){
        Double latitude;
        Double longitude;
